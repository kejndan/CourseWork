...
if __name__ == '__main__':
    name = 'classification/mushrooms.csv'
    ...
    pp = preprocessing.PreProcessing(df, 0)
    ...
    for i in range(5) :
        ...
        # GB.cv = 3
        s = time()
        GB = genetic_algorithm.GeneticClassification(population_size=50, n_generations=5, name=name)
        GB.cv = 3
